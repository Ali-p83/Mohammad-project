...
namespace WindowsFormsApp2 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Tell) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Tell {
                get {
                    try {
                        return ((string)(this[this.tableTable.TellColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Tell\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.TellColumn] = value;
                }
            }
            ...
            public bool IsTellNull() {
                return this.IsNull(this.tableTable.TellColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetTellNull() {
                this[this.tableTable.TellColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApp2.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Tell = 1 AND" +
                " [Tell] IS NULL) OR ([Tell] = @Original_Tell)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Tell]) VALUES (@Id, @Name, @Tell);\r\nSEL" +
                "ECT Id, Name, Tell FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Tell] = @Tell WHERE (([Id] " +
                "= @Original_Id) AND ((@IsNull_Tell = 1 AND [Tell] IS NULL) OR ([Tell] = @Origina" +
                "l_Tell)));\r\nSELECT Id, Name, Tell FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Tell FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Tell) {
            ...
            if ((Original_Tell == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_Tell));
            }
        ...
        public virtual int Insert(int Id, string Name, string Tell) {
        ...
        public virtual int Update(int Id, string Name, string Tell, int Original_Id, string Original_Tell) {
            ...
            if ((Original_Tell == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_Tell));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Tell, int Original_Id, string Original_Tell) {
            return this.Update(Original_Id, Name, Tell, Original_Id, Original_Tell);
        }
    }
